        ...
        >
          ...
          <View style={{ flex: 1 }}>
            {sweepState === "neutral" && (
              <>
                <T size="small" center>
                  To recover Zclassic (ZCL) or ZSLP Tokens from a paper wallet,
                ...
                <Spacer small />
                <T size="small">4. Sweep to your Panda Crypto Wallet.</T>
                <Spacer small />
                <T size="small">
                  5. Repeat until all ZCL and tokens have been swept.
                </T>
              </>
            )}
              ...
              <>
                ...
                {paperBalances["BCH"] && (
                  <>
                    <T>Zclassic</T>
                    <Spacer minimal />
                    <T weight="bold">{paperBalances["BCH"].toFormat()} ZCL</T>
                    <Spacer small />
                  </>
                )}
                  ...
                  {paperBalances["BCH"] && (
                    <>
                      ...
                      <T type="primary" size="large" center weight="bold">
                        {paperBalances["BCH"].toFormat()} ZCL
                      </T>
                    </>
                  )}
                  {paperBalances[tokenId] && (
